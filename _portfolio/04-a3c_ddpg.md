...
This project provided hands-on experience with neural network design, policy optimization, exploration strategies, hyperparameter tuning, and reinforcement learning performance analysis.

- Implement DDPG and A3C reinforcement learning agents.
- Train agents in a continuous-action robotic environment.
...
Throughout training I monitored the performance with logging the following:
